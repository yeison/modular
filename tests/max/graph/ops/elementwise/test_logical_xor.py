...
def test_logical_xor__same_type(graph_builder, tensor_type: TensorType) -> None:  # noqa: ANN001
...
def test_logical_xor__broadcast(graph_builder, shapes: list[Shape]) -> None:  # noqa: ANN001
    s1, s2 = shapes
