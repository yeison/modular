...
fn curandCreatePoissonDistribution(
    ...
    Construct the histogram array for the Poisson distribution with func \\p func.
...
fn curandGeneratePoisson(
    ...
    Results are 32-bit unsigned int point values with Poisson distribution, with func \\p func.
