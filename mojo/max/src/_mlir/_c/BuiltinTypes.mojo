...
#
# Last generated by connorgray at 2024-07-03 18:53:28.095812 with command
# ```
...
fn mlirTypeIsAFloat(type: MlirType) -> Bool:
    ...
    return MLIR_func["mlirTypeIsAFloat", fn (MlirType) -> Bool]()(type)


fn mlirFloatTypeGetWidth(type: MlirType) -> Int16:
    """Returns the bitwidth of a floating-point type."""
    return MLIR_func["mlirFloatTypeGetWidth", fn (MlirType) -> Int16]()(type)
...
fn mlirVectorTypeGet(
    ...
    return MLIR_func[
        "mlirVectorTypeGet",
        fn (Int, UnsafePointer[Int64], MlirType) -> MlirType,
...
fn mlirVectorTypeGetChecked(
    ...
    return MLIR_func[
        ...
        fn (MlirLocation, Int, UnsafePointer[Int64], MlirType) -> MlirType,
...
fn mlirVectorTypeGetScalable(
    ...
    return MLIR_func[
        ...
        fn (
            Int, UnsafePointer[Int64], UnsafePointer[Bool], MlirType
        ) -> MlirType,
...
fn mlirRankedTensorTypeGet(
    ...
    return MLIR_func[
        ...
        fn (Int, UnsafePointer[Int64], MlirType, MlirAttribute) -> MlirType,
...
fn mlirRankedTensorTypeGetChecked(
    ...
    return MLIR_func[
        ...
        fn (
            MlirLocation, Int, UnsafePointer[Int64], MlirType, MlirAttribute
        ) -> MlirType,
...
fn mlirMemRefTypeGet(
    ...
    return MLIR_func[
        "mlirMemRefTypeGet",
        fn (
            MlirType, Int, UnsafePointer[Int64], MlirAttribute, MlirAttribute
        ) -> MlirType,
...
fn mlirMemRefTypeContiguousGet(
    ...
    return MLIR_func[
        ...
        fn (MlirType, Int, UnsafePointer[Int64], MlirAttribute) -> MlirType,
...
fn mlirMemRefTypeContiguousGetChecked(
    ...
    return MLIR_func[
        ...
        fn (
            MlirLocation, MlirType, Int, UnsafePointer[Int64], MlirAttribute
        ) -> MlirType,
...
fn mlirMemRefTypeGetStridesAndOffset(
    ...
    return MLIR_func[
        ...
        fn (
            MlirType, UnsafePointer[Int64], UnsafePointer[Int64]
        ) -> MlirLogicalResult,
    ]()(type, strides, offset)
...
fn mlirTupleTypeGet(
    ...
    return MLIR_func[
        "mlirTupleTypeGet",
        fn (MlirContext, Int, UnsafePointer[MlirType]) -> MlirType,
