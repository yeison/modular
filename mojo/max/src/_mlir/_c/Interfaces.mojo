...
#
# Last generated by stef at 2024-01-12 08:19:32.725215 with command
# ```
...
fn mlirOperationImplementsInterface(
    ...
    return MLIR_func[
        ...
        fn (MlirOperation, MlirTypeID) -> Bool,
...
fn mlirOperationImplementsInterfaceStatic(
    ...
    return MLIR_func[
        ...
        fn (MlirStringRef, MlirContext, MlirTypeID) -> Bool,
...
fn mlirInferTypeOpInterfaceTypeID() -> MlirTypeID:
    ...
    return MLIR_func["mlirInferTypeOpInterfaceTypeID", fn () -> MlirTypeID]()()
...
alias MlirTypesCallback = fn (
    Int32, Pointer[MlirType], Pointer[NoneType]
) -> NoneType
...
fn mlirInferTypeOpInterfaceInferReturnTypes(
    ...
    properties: Pointer[NoneType],
    n_regions: Int,
    regions: Pointer[MlirRegion],
    callback: fn (Int32, Pointer[MlirType], Pointer[NoneType]) -> NoneType,
    ...
    return MLIR_func[
        ...
        fn (
            ...
            Int,
            Pointer[MlirRegion],
            fn (Int32, Pointer[MlirType], Pointer[NoneType]) -> NoneType,
            Pointer[NoneType],
        ) -> MlirLogicalResult,
    ]()(
        op_name,
...
fn mlirInferShapedTypeOpInterfaceTypeID() -> MlirTypeID:
    ...
    return MLIR_func[
        "mlirInferShapedTypeOpInterfaceTypeID", fn () -> MlirTypeID
    ]()()
...
alias MlirShapedTypeComponentsCallback = fn (
    Bool, Int32, Pointer[Int64], MlirType, MlirAttribute, Pointer[NoneType]
) -> NoneType
