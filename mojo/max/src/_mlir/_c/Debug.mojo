...
#
# Last generated by connorgray at 2024-07-04 09:06:46.797601 with command
# ```
...
fn mlirEnableGlobalDebug(enable: Bool) -> None:
    ...
    return MLIR_func["mlirEnableGlobalDebug", fn (Bool) -> None]()(enable)
...
fn mlirSetGlobalDebugType(type: UnsafePointer[Int8]) -> None:
    ...
    to be produced."""
    return MLIR_func[
        "mlirSetGlobalDebugType", fn (UnsafePointer[Int8]) -> None
    ]()(type)
...
fn mlirSetGlobalDebugTypes(
    ...
    return MLIR_func[
        ...
        fn (UnsafePointer[UnsafePointer[Int8]], Int) -> None,
    ]()(types, n)
