...
#
# Last generated by connorgray at 2024-07-04 09:06:48.098421 with command
# ```
...
fn mlirRegisterAllDialects(registry: MlirDialectRegistry) -> None:
    ...
    return MLIR_func[
        "mlirRegisterAllDialects", fn (MlirDialectRegistry) -> None
    ]()(registry)
...
fn mlirRegisterAllLLVMTranslations(context: MlirContext) -> None:
    ...
    return MLIR_func[
        "mlirRegisterAllLLVMTranslations", fn (MlirContext) -> None
    ]()(context)


fn mlirRegisterAllPasses() -> None:
    """Register all compiler passes of MLIR."""
    return MLIR_func["mlirRegisterAllPasses", fn () -> None]()()
