...
#
# Last generated by connorgray at 2024-07-04 09:06:48.353498 with command
# ```
...
fn mlirStringRefCreateFromCString(str: UnsafePointer[Int8]) -> MlirStringRef:
    ...
    return MLIR_func[
        ...
        fn (UnsafePointer[Int8]) -> MlirStringRef,
    ]()(str)
...
fn mlirLlvmThreadPoolDestroy(pool: MlirLlvmThreadPool) -> None:
    ...
    return MLIR_func[
        "mlirLlvmThreadPoolDestroy", fn (MlirLlvmThreadPool) -> None
    ]()(pool)
...
fn mlirTypeIDCreate(ptr: UnsafePointer[NoneType]) -> MlirTypeID:
    ...
    return MLIR_func[
        "mlirTypeIDCreate", fn (UnsafePointer[NoneType]) -> MlirTypeID
    ]()(ptr)
...
fn mlirTypeIDAllocatorDestroy(allocator: MlirTypeIDAllocator) -> None:
    ...
    return MLIR_func[
        "mlirTypeIDAllocatorDestroy", fn (MlirTypeIDAllocator) -> None
    ]()(allocator)
