...
#
# Last generated by connorgray at 2024-07-03 18:53:29.618273 with command
# ```
...
fn mlirPrintPassPipeline(
    ...
    return MLIR_func[
        ...
        fn (
            MlirOpPassManager, MlirStringCallback, UnsafePointer[NoneType]
        ) -> NoneType,
...
struct MlirExternalPassCallbacks:
    ...
    var construct: fn (UnsafePointer[NoneType]) -> NoneType
    # This callback is called when the pass is destroyed
    # This is analogous to a C++ pass destructor.
    var destruct: fn (UnsafePointer[NoneType]) -> NoneType
...
fn mlirCreateExternalPass(
    ...
    return MLIR_func[
        ...
        fn (
            ...
            MlirStringRef,
            Int,
            UnsafePointer[MlirDialectHandle],
