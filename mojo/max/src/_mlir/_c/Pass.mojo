...
#
# Last generated by connorgray at 2024-07-04 09:06:47.942427 with command
# ```
...
fn mlirPassManagerDestroy(pass_manager: MlirPassManager) -> None:
    ...
    return MLIR_func["mlirPassManagerDestroy", fn (MlirPassManager) -> None]()(
        pass_manager
    )
...
fn mlirPassManagerEnableIRPrinting(pass_manager: MlirPassManager) -> None:
    ...
    return MLIR_func[
        "mlirPassManagerEnableIRPrinting", fn (MlirPassManager) -> None
    ]()(pass_manager)
...
fn mlirPassManagerEnableVerifier(
    ...
    return MLIR_func[
        "mlirPassManagerEnableVerifier", fn (MlirPassManager, Bool) -> None
    ]()(pass_manager, enable)
...
fn mlirPassManagerAddOwnedPass(
    ...
    return MLIR_func[
        "mlirPassManagerAddOwnedPass", fn (MlirPassManager, MlirPass) -> None
    ]()(pass_manager, `pass`)
...
fn mlirOpPassManagerAddOwnedPass(
    ...
    return MLIR_func[
        ...
        fn (MlirOpPassManager, MlirPass) -> None,
    ]()(pass_manager, `pass`)
...
fn mlirExternalPassSignalFailure(`pass`: MlirExternalPass) -> None:
    ...
    return MLIR_func[
        "mlirExternalPassSignalFailure", fn (MlirExternalPass) -> None
    ]()(`pass`)
