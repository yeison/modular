...
#
# Last generated by stef at 2024-01-12 08:19:32.880833 with command
# ```
...
fn mlirPassManagerCreate(ctx: MlirContext) -> MlirPassManager:
    ...
    return MLIR_func[
        "mlirPassManagerCreate", fn (MlirContext) -> MlirPassManager
    ]()(ctx)
...
fn mlirPassManagerCreateOnOperation(
    ...
    return MLIR_func[
        ...
        fn (MlirContext, MlirStringRef) -> MlirPassManager,
    ]()(ctx, anchor_op)


fn mlirPassManagerDestroy(pass_manager: MlirPassManager) -> NoneType:
    """Destroy the provided PassManager."""
    return MLIR_func[
        "mlirPassManagerDestroy", fn (MlirPassManager) -> NoneType
    ]()(pass_manager)
...
fn mlirPassManagerGetAsOpPassManager(
    ...
    return MLIR_func[
        ...
        fn (MlirPassManager) -> MlirOpPassManager,
    ]()(pass_manager)
...
fn mlirPassManagerRunOnOp(
    ...
    return MLIR_func[
        ...
        fn (MlirPassManager, MlirOperation) -> MlirLogicalResult,
    ]()(pass_manager, op)


fn mlirPassManagerEnableIRPrinting(pass_manager: MlirPassManager) -> NoneType:
    """Enable mlir-print-ir-after-all."""
    return MLIR_func[
        "mlirPassManagerEnableIRPrinting", fn (MlirPassManager) -> NoneType
    ]()(pass_manager)
...
fn mlirPassManagerEnableVerifier(
    ...
    return MLIR_func[
        "mlirPassManagerEnableVerifier", fn (MlirPassManager, Bool) -> NoneType
    ]()(pass_manager, enable)
...
fn mlirPassManagerGetNestedUnder(
    ...
    return MLIR_func[
        ...
        fn (MlirPassManager, MlirStringRef) -> MlirOpPassManager,
...
fn mlirOpPassManagerGetNestedUnder(
    ...
    return MLIR_func[
        ...
        fn (MlirOpPassManager, MlirStringRef) -> MlirOpPassManager,
    ]()(pass_manager, operation_name)
...
fn mlirPassManagerAddOwnedPass(
    ...
    return MLIR_func[
        ...
        fn (MlirPassManager, MlirPass) -> NoneType,
    ]()(pass_manager, `pass`)
...
fn mlirOpPassManagerAddOwnedPass(
    ...
    return MLIR_func[
        ...
        fn (MlirOpPassManager, MlirPass) -> NoneType,
    ]()(pass_manager, `pass`)
...
struct MlirExternalPassCallbacks:
    ...
    var initialize: fn (MlirContext, Pointer[NoneType]) -> MlirLogicalResult
    # This callback is called when the pass is cloned.
    # See Pass::clonePass().
    var clone: fn (Pointer[NoneType]) -> Pointer[NoneType]
    # This callback is called when the pass is run.
    # See Pass::runOnOperation().
    var run: fn (MlirOperation, MlirExternalPass, Pointer[NoneType]) -> NoneType
...
fn mlirCreateExternalPass(
    ...
    dependent_dialects: Pointer[MlirDialectHandle],
...
fn mlirExternalPassSignalFailure(`pass`: MlirExternalPass) -> NoneType:
    ...
    return MLIR_func[
        "mlirExternalPassSignalFailure", fn (MlirExternalPass) -> NoneType
    ]()(`pass`)
