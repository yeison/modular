...
#
# Last generated by connorgray at 2024-07-04 09:06:48.224889 with command
# ```
...
fn mlirFrozenRewritePatternSetDestroy(op: MlirFrozenRewritePatternSet) -> None:
    return MLIR_func[
        ...
        fn (MlirFrozenRewritePatternSet) -> None,
    ]()(op)
...
fn mlirPDLPatternModuleDestroy(op: MlirPDLPatternModule) -> None:
    return MLIR_func[
        "mlirPDLPatternModuleDestroy", fn (MlirPDLPatternModule) -> None
    ]()(op)
