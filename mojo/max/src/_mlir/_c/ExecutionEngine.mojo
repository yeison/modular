...
#
# Last generated by connorgray at 2024-07-04 09:06:47.048327 with command
# ```
...
fn mlirExecutionEngineCreate(
    ...
    return MLIR_func[
        ...
        fn (
            MlirModule, Int16, Int16, UnsafePointer[MlirStringRef], Bool
        ) -> MlirExecutionEngine,
...
fn mlirExecutionEngineDestroy(jit: MlirExecutionEngine) -> None:
    ...
    return MLIR_func[
        "mlirExecutionEngineDestroy", fn (MlirExecutionEngine) -> None
    ]()(jit)
...
fn mlirExecutionEngineLookupPacked(
    ...
    return MLIR_func[
        ...
        fn (MlirExecutionEngine, MlirStringRef) -> UnsafePointer[NoneType],
    ]()(jit, name)
...
fn mlirExecutionEngineRegisterSymbol(
    ...
    return MLIR_func[
        ...
        fn (
            MlirExecutionEngine, MlirStringRef, UnsafePointer[NoneType]
        ) -> None,
    ]()(jit, name, sym)
...
fn mlirExecutionEngineDumpToObjectFile(
    ...
    return MLIR_func[
        ...
        fn (MlirExecutionEngine, MlirStringRef) -> None,
    ]()(jit, file_name)
