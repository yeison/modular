...
#
# Last generated by connorgray at 2024-07-03 18:53:27.533125 with command
# ```
...
fn mlirAffineMapPrint(
    ...
    return MLIR_func[
        "mlirAffineMapPrint",
        fn (
            MlirAffineMap, MlirStringCallback, UnsafePointer[NoneType]
        ) -> NoneType,
...
fn mlirAffineMapGet(
    ...
    return MLIR_func[
        "mlirAffineMapGet",
        fn (
            MlirContext, Int, Int, Int, UnsafePointer[MlirAffineExpr]
        ) -> MlirAffineMap,
...
fn mlirAffineMapPermutationGet(
    ...
    return MLIR_func[
        ...
        fn (MlirContext, Int, UnsafePointer[Int16]) -> MlirAffineMap,
...
fn mlirAffineMapGetSubMap(
    ...
    return MLIR_func[
        ...
        fn (MlirAffineMap, Int, UnsafePointer[Int]) -> MlirAffineMap,
...
fn mlirAffineMapCompressUnusedSymbols(
    ...
    populate_result: fn (
        UnsafePointer[NoneType], Int32, MlirAffineMap
    ) -> NoneType,
) -> NoneType:
    ...
    return MLIR_func[
        ...
        fn (
            UnsafePointer[MlirAffineMap],
            Int,
            UnsafePointer[NoneType],
            fn (UnsafePointer[NoneType], Int32, MlirAffineMap) -> NoneType,
        ) -> NoneType,
