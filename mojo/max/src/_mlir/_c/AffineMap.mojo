...
#
# Last generated by stef at 2024-01-12 08:19:30.642670 with command
# ```
...
fn mlirAffineMapGetContext(affine_map: MlirAffineMap) -> MlirContext:
    ...
    return MLIR_func[
        "mlirAffineMapGetContext", fn (MlirAffineMap) -> MlirContext
    ]()(affine_map)
...
fn mlirAffineMapEqual(a1: MlirAffineMap, a2: MlirAffineMap) -> Bool:
    ...
    return MLIR_func[
        "mlirAffineMapEqual", fn (MlirAffineMap, MlirAffineMap) -> Bool
    ]()(a1, a2)
...
fn mlirAffineMapDump(affine_map: MlirAffineMap) -> NoneType:
    """Prints the affine map to the standard error stream."""
    return MLIR_func["mlirAffineMapDump", fn (MlirAffineMap) -> NoneType]()(
        affine_map
    )
...
fn mlirAffineMapEmptyGet(ctx: MlirContext) -> MlirAffineMap:
    ...
    return MLIR_func[
        "mlirAffineMapEmptyGet", fn (MlirContext) -> MlirAffineMap
    ]()(ctx)
...
fn mlirAffineMapZeroResultGet(
    ...
    return MLIR_func[
        ...
        fn (MlirContext, Int, Int) -> MlirAffineMap,
...
fn mlirAffineMapGet(
    ...
    symbol_count: Int,
    n_affine_exprs: Int,
    affine_exprs: Pointer[MlirAffineExpr],
) -> MlirAffineMap:
    """Creates an affine map with results defined by the given list of affine
    expressions. The map resulting map also has the requested number of input
    dimensions and symbols, regardless of them being used in the results."""
    return MLIR_func[
        "mlirAffineMapGet",
        fn (
            MlirContext, Int, Int, Int, Pointer[MlirAffineExpr]
        ) -> MlirAffineMap,
...
fn mlirAffineMapConstantGet(ctx: MlirContext, val: Int64) -> MlirAffineMap:
    ...
    return MLIR_func[
        "mlirAffineMapConstantGet", fn (MlirContext, Int64) -> MlirAffineMap
    ]()(ctx, val)
...
fn mlirAffineMapMultiDimIdentityGet(
    ...
    return MLIR_func[
        ...
        fn (MlirContext, Int) -> MlirAffineMap,
    ]()(ctx, num_dims)
...
fn mlirAffineMapPermutationGet(
    ctx: MlirContext, size: Int, permutation: Pointer[Int16]
) -> MlirAffineMap:
    ...
    return MLIR_func[
        ...
        fn (MlirContext, Int, Pointer[Int16]) -> MlirAffineMap,
...
fn mlirAffineMapIsIdentity(affine_map: MlirAffineMap) -> Bool:
    ...
    results."""
    return MLIR_func["mlirAffineMapIsIdentity", fn (MlirAffineMap) -> Bool]()(
        affine_map
    )
...
fn mlirAffineMapIsMinorIdentity(affine_map: MlirAffineMap) -> Bool:
    ...
    return MLIR_func[
        "mlirAffineMapIsMinorIdentity", fn (MlirAffineMap) -> Bool
    ]()(affine_map)


fn mlirAffineMapIsEmpty(affine_map: MlirAffineMap) -> Bool:
    """Checks whether the given affine map is an empty affine map."""
    return MLIR_func["mlirAffineMapIsEmpty", fn (MlirAffineMap) -> Bool]()(
        affine_map
    )
...
fn mlirAffineMapIsSingleConstant(affine_map: MlirAffineMap) -> Bool:
    ...
    map."""
    return MLIR_func[
        "mlirAffineMapIsSingleConstant", fn (MlirAffineMap) -> Bool
    ]()(affine_map)
...
fn mlirAffineMapGetSingleConstantResult(affine_map: MlirAffineMap) -> Int64:
    ...
    return MLIR_func[
        "mlirAffineMapGetSingleConstantResult", fn (MlirAffineMap) -> Int64
    ]()(affine_map)


fn mlirAffineMapGetNumDims(affine_map: MlirAffineMap) -> Int:
    """Returns the number of dimensions of the given affine map."""
    return MLIR_func["mlirAffineMapGetNumDims", fn (MlirAffineMap) -> Int]()(
        affine_map
    )
...
fn mlirAffineMapGetNumSymbols(affine_map: MlirAffineMap) -> Int:
    ...
    return MLIR_func["mlirAffineMapGetNumSymbols", fn (MlirAffineMap) -> Int]()(
        affine_map
    )
...
fn mlirAffineMapGetNumResults(affine_map: MlirAffineMap) -> Int:
    ...
    return MLIR_func["mlirAffineMapGetNumResults", fn (MlirAffineMap) -> Int]()(
        affine_map
    )
...
fn mlirAffineMapGetResult(
    ...
    return MLIR_func[
        "mlirAffineMapGetResult", fn (MlirAffineMap, Int) -> MlirAffineExpr
    ]()(affine_map, pos)
...
fn mlirAffineMapGetNumInputs(affine_map: MlirAffineMap) -> Int:
    ...
    map."""
    return MLIR_func["mlirAffineMapGetNumInputs", fn (MlirAffineMap) -> Int]()(
        affine_map
    )
...
fn mlirAffineMapIsProjectedPermutation(affine_map: MlirAffineMap) -> Bool:
    ...
    permutation map."""
    return MLIR_func[
        "mlirAffineMapIsProjectedPermutation", fn (MlirAffineMap) -> Bool
    ]()(affine_map)
...
fn mlirAffineMapIsPermutation(affine_map: MlirAffineMap) -> Bool:
    ...
    map."""
    return MLIR_func[
        "mlirAffineMapIsPermutation", fn (MlirAffineMap) -> Bool
    ]()(affine_map)


fn mlirAffineMapGetSubMap(
    affine_map: MlirAffineMap, size: Int, result_pos: Pointer[Int]
) -> MlirAffineMap:
    """Returns the affine map consisting of the `resultPos` subset."""
    return MLIR_func[
        "mlirAffineMapGetSubMap",
        fn (MlirAffineMap, Int, Pointer[Int]) -> MlirAffineMap,
...
fn mlirAffineMapGetMajorSubMap(
    ...
    return MLIR_func[
        "mlirAffineMapGetMajorSubMap", fn (MlirAffineMap, Int) -> MlirAffineMap
...
fn mlirAffineMapGetMinorSubMap(
    ...
    results of the given affine map."""
    return MLIR_func[
        "mlirAffineMapGetMinorSubMap", fn (MlirAffineMap, Int) -> MlirAffineMap
    ]()(affine_map, num_results)
...
fn mlirAffineMapReplace(
    ...
    return MLIR_func[
        ...
        fn (
            MlirAffineMap, MlirAffineExpr, MlirAffineExpr, Int, Int
        ) -> MlirAffineMap,
    ]()(affine_map, expression, replacement, num_result_dims, num_result_syms)


fn mlirAffineMapCompressUnusedSymbols(
    affine_maps: Pointer[MlirAffineMap],
    size: Int,
    result: Pointer[NoneType],
    populate_result: fn (Pointer[NoneType], Int32, MlirAffineMap) -> NoneType,
) -> NoneType:
    ...
    return MLIR_func[
        ...
        fn (
            Pointer[MlirAffineMap],
            Int,
            Pointer[NoneType],
            fn (Pointer[NoneType], Int32, MlirAffineMap) -> NoneType,
        ) -> NoneType,
