...
#
# Last generated by connorgray at 2024-07-04 09:06:45.873075 with command
# ```
...
fn mlirAffineMapPrint(
    ...
    return MLIR_func[
        "mlirAffineMapPrint",
        fn (MlirAffineMap, MlirStringCallback, UnsafePointer[NoneType]) -> None,
    ]()(affine_map, callback, user_data)


fn mlirAffineMapDump(affine_map: MlirAffineMap) -> None:
    """Prints the affine map to the standard error stream."""
    return MLIR_func["mlirAffineMapDump", fn (MlirAffineMap) -> None]()(
        affine_map
    )
...
fn mlirAffineMapCompressUnusedSymbols(
    ...
    return MLIR_func[
        ...
        fn (
            ...
            fn (UnsafePointer[NoneType], Int32, MlirAffineMap) -> None,
        ) -> None,
