...
#
# Last generated by connorgray at 2024-07-04 09:06:47.192455 with command
# ```
...
fn mlirContextDestroy(context: MlirContext) -> None:
    ...
    return MLIR_func["mlirContextDestroy", fn (MlirContext) -> None]()(context)
...
fn mlirContextAppendDialectRegistry(
    ...
    return MLIR_func[
        ...
        fn (MlirContext, MlirDialectRegistry) -> None,
    ]()(ctx, registry)
...
fn mlirContextEnableMultithreading(context: MlirContext, enable: Bool) -> None:
    ...
    return MLIR_func[
        "mlirContextEnableMultithreading", fn (MlirContext, Bool) -> None
    ]()(context, enable)
...
fn mlirContextLoadAllAvailableDialects(context: MlirContext) -> None:
    ...
    return MLIR_func[
        "mlirContextLoadAllAvailableDialects", fn (MlirContext) -> None
    ]()(context)
...
fn mlirContextSetThreadPool(
    ...
    return MLIR_func[
        "mlirContextSetThreadPool", fn (MlirContext, MlirLlvmThreadPool) -> None
    ]()(context, thread_pool)
...
fn mlirDialectHandleInsertDialect(
    ...
    return MLIR_func[
        ...
        fn (MlirDialectHandle, MlirDialectRegistry) -> None,
    ]()(a, b)
...
fn mlirDialectHandleRegisterDialect(
    ...
    return MLIR_func[
        ...
        fn (MlirDialectHandle, MlirContext) -> None,
    ]()(a, b)
...
fn mlirDialectRegistryDestroy(registry: MlirDialectRegistry) -> None:
    ...
    return MLIR_func[
        "mlirDialectRegistryDestroy", fn (MlirDialectRegistry) -> None
    ]()(registry)
...
fn mlirLocationPrint(
    ...
    return MLIR_func[
        "mlirLocationPrint",
        fn (MlirLocation, MlirStringCallback, UnsafePointer[NoneType]) -> None,
...
fn mlirModuleDestroy(module: MlirModule) -> None:
    ...
    return MLIR_func["mlirModuleDestroy", fn (MlirModule) -> None]()(module)
...
fn mlirOperationStateEnableResultTypeInference(
    ...
    return MLIR_func[
        ...
        fn (UnsafePointer[MlirOperationState]) -> None,
    ]()(state)
...
fn mlirAsmStateDestroy(state: MlirAsmState) -> None:
    ...
    return MLIR_func["mlirAsmStateDestroy", fn (MlirAsmState) -> None]()(state)
...
fn mlirOpPrintingFlagsDestroy(flags: MlirOpPrintingFlags) -> None:
    ...
    return MLIR_func[
        "mlirOpPrintingFlagsDestroy", fn (MlirOpPrintingFlags) -> None
    ]()(flags)
...
fn mlirOpPrintingFlagsElideLargeElementsAttrs(
    ...
    return MLIR_func[
        ...
        fn (MlirOpPrintingFlags, Int) -> None,
...
fn mlirOpPrintingFlagsEnableDebugInfo(
    ...
    return MLIR_func[
        ...
        fn (MlirOpPrintingFlags, Bool, Bool) -> None,
...
fn mlirOpPrintingFlagsUseLocalScope(flags: MlirOpPrintingFlags) -> None:
    ...
    the full module."""
    return MLIR_func[
        "mlirOpPrintingFlagsUseLocalScope", fn (MlirOpPrintingFlags) -> None
    ]()(flags)
...
fn mlirOpPrintingFlagsAssumeVerified(flags: MlirOpPrintingFlags) -> None:
    ...
    return MLIR_func[
        "mlirOpPrintingFlagsAssumeVerified", fn (MlirOpPrintingFlags) -> None
    ]()(flags)
...
fn mlirOpPrintingFlagsSkipRegions(flags: MlirOpPrintingFlags) -> None:
    ...
    return MLIR_func[
        "mlirOpPrintingFlagsSkipRegions", fn (MlirOpPrintingFlags) -> None
    ]()(flags)
...
fn mlirBytecodeWriterConfigDestroy(config: MlirBytecodeWriterConfig) -> None:
    ...
    return MLIR_func[
        "mlirBytecodeWriterConfigDestroy", fn (MlirBytecodeWriterConfig) -> None
    ]()(config)
...
fn mlirBytecodeWriterConfigDesiredEmitVersion(
    ...
    return MLIR_func[
        ...
        fn (MlirBytecodeWriterConfig, Int64) -> None,
    ]()(flags, version)
...
fn mlirOperationDestroy(op: MlirOperation) -> None:
    ...
    return MLIR_func["mlirOperationDestroy", fn (MlirOperation) -> None]()(op)
...
fn mlirOperationRemoveFromParent(op: MlirOperation) -> None:
    ...
    return MLIR_func[
        "mlirOperationRemoveFromParent", fn (MlirOperation) -> None
    ]()(op)
...
fn mlirOperationSetOperand(
    ...
    return MLIR_func[
        "mlirOperationSetOperand", fn (MlirOperation, Int, MlirValue) -> None
    ]()(op, pos, new_value)
...
fn mlirOperationSetOperands(
    ...
    return MLIR_func[
        ...
        fn (MlirOperation, Int, UnsafePointer[MlirValue]) -> None,
...
fn mlirOperationSetSuccessor(
    ...
    return MLIR_func[
        "mlirOperationSetSuccessor", fn (MlirOperation, Int, MlirBlock) -> None
    ]()(op, pos, block)
...
fn mlirOperationSetInherentAttributeByName(
    ...
    return MLIR_func[
        ...
        fn (MlirOperation, MlirStringRef, MlirAttribute) -> None,
    ]()(op, name, attr)
...
fn mlirOperationPrint(
    ...
    return MLIR_func[
        "mlirOperationPrint",
        fn (MlirOperation, MlirStringCallback, UnsafePointer[NoneType]) -> None,
...
fn mlirOperationDump(op: MlirOperation) -> None:
    ...
    return MLIR_func["mlirOperationDump", fn (MlirOperation) -> None]()(op)
...
fn mlirOperationMoveAfter(op: MlirOperation, other: MlirOperation) -> None:
    ...
    return MLIR_func[
        "mlirOperationMoveAfter", fn (MlirOperation, MlirOperation) -> None
    ]()(op, other)
...
fn mlirOperationMoveBefore(op: MlirOperation, other: MlirOperation) -> None:
    ...
    ownership is transferred to the block of the other operation."""
    return MLIR_func[
        "mlirOperationMoveBefore", fn (MlirOperation, MlirOperation) -> None
    ]()(op, other)
...
fn mlirRegionDestroy(region: MlirRegion) -> None:
    ...
    return MLIR_func["mlirRegionDestroy", fn (MlirRegion) -> None]()(region)
...
fn mlirRegionAppendOwnedBlock(region: MlirRegion, block: MlirBlock) -> None:
    ...
    return MLIR_func[
        "mlirRegionAppendOwnedBlock", fn (MlirRegion, MlirBlock) -> None
    ]()(region, block)
...
fn mlirRegionInsertOwnedBlock(
    ...
    return MLIR_func[
        "mlirRegionInsertOwnedBlock", fn (MlirRegion, Int, MlirBlock) -> None
    ]()(region, pos, block)
...
fn mlirRegionInsertOwnedBlockAfter(
    ...
    return MLIR_func[
        ...
        fn (MlirRegion, MlirBlock, MlirBlock) -> None,
...
fn mlirRegionTakeBody(target: MlirRegion, source: MlirRegion) -> None:
    ...
    return MLIR_func[
        "mlirRegionTakeBody", fn (MlirRegion, MlirRegion) -> None
    ]()(target, source)
...
fn mlirBlockDestroy(block: MlirBlock) -> None:
    ...
    return MLIR_func["mlirBlockDestroy", fn (MlirBlock) -> None]()(block)


fn mlirBlockDetach(block: MlirBlock) -> None:
    """Detach a block from the owning region and assume ownership."""
    return MLIR_func["mlirBlockDetach", fn (MlirBlock) -> None]()(block)
...
fn mlirBlockAppendOwnedOperation(
    ...
    return MLIR_func[
        "mlirBlockAppendOwnedOperation", fn (MlirBlock, MlirOperation) -> None
    ]()(block, operation)
...
fn mlirBlockInsertOwnedOperation(
    ...
    return MLIR_func[
        ...
        fn (MlirBlock, Int, MlirOperation) -> None,
    ]()(block, pos, operation)
...
fn mlirBlockInsertOwnedOperationAfter(
    ...
    return MLIR_func[
        ...
        fn (MlirBlock, MlirOperation, MlirOperation) -> None,
...
fn mlirBlockEraseArgument(block: MlirBlock, index: Int16) -> None:
    ...
    return MLIR_func["mlirBlockEraseArgument", fn (MlirBlock, Int16) -> None]()(
        block, index
    )
...
fn mlirBlockPrint(
    ...
    return MLIR_func[
        "mlirBlockPrint",
        fn (MlirBlock, MlirStringCallback, UnsafePointer[NoneType]) -> None,
...
fn mlirBlockArgumentSetType(value: MlirValue, type: MlirType) -> None:
    ...
    return MLIR_func[
        "mlirBlockArgumentSetType", fn (MlirValue, MlirType) -> None
    ]()(value, type)
...
fn mlirValueSetType(value: MlirValue, type: MlirType) -> None:
    ...
    return MLIR_func["mlirValueSetType", fn (MlirValue, MlirType) -> None]()(
        value, type
    )
...
fn mlirValueDump(value: MlirValue) -> None:
    ...
    return MLIR_func["mlirValueDump", fn (MlirValue) -> None]()(value)
...
fn mlirValuePrint(
    ...
    return MLIR_func[
        "mlirValuePrint",
        fn (MlirValue, MlirStringCallback, UnsafePointer[NoneType]) -> None,
...
fn mlirValueReplaceAllUsesOfWith(of: MlirValue, `with`: MlirValue) -> None:
    ...
    return MLIR_func[
        "mlirValueReplaceAllUsesOfWith", fn (MlirValue, MlirValue) -> None
    ]()(of, `with`)
...
fn mlirTypePrint(
    ...
    return MLIR_func[
        "mlirTypePrint",
        fn (MlirType, MlirStringCallback, UnsafePointer[NoneType]) -> None,
    ]()(type, callback, user_data)


fn mlirTypeDump(type: MlirType) -> None:
    """Prints the type to the standard error stream."""
    return MLIR_func["mlirTypeDump", fn (MlirType) -> None]()(type)
...
fn mlirAttributePrint(
    ...
    return MLIR_func[
        "mlirAttributePrint",
        fn (MlirAttribute, MlirStringCallback, UnsafePointer[NoneType]) -> None,
    ]()(attr, callback, user_data)


fn mlirAttributeDump(attr: MlirAttribute) -> None:
    """Prints the attribute to the standard error stream."""
    return MLIR_func["mlirAttributeDump", fn (MlirAttribute) -> None]()(attr)
...
fn mlirSymbolTableDestroy(symbol_table: MlirSymbolTable) -> None:
    ...
    return MLIR_func["mlirSymbolTableDestroy", fn (MlirSymbolTable) -> None]()(
        symbol_table
    )
...
fn mlirSymbolTableErase(
    ...
    return MLIR_func[
        "mlirSymbolTableErase", fn (MlirSymbolTable, MlirOperation) -> None
    ]()(symbol_table, operation)
...
fn mlirSymbolTableWalkSymbolTables(
    ...
    return MLIR_func[
        ...
        fn (
            MlirOperation,
            Bool,
            fn (MlirOperation, Bool, UnsafePointer[NoneType]) -> None,
            UnsafePointer[NoneType],
        ) -> None,
