...
#
# Last generated by stef at 2024-01-12 08:19:32.099880 with command
# ```
...
fn mlirLocationFusedGet(
    ctx: MlirContext,
    n_locations: Int,
    locations: Pointer[MlirLocation],
    ...
    return MLIR_func[
        ...
        fn (
            MlirContext, Int, Pointer[MlirLocation], MlirAttribute
        ) -> MlirLocation,
...
struct MlirOperationState:
    ...
    var nResults: Int
    var results: Pointer[MlirType]
    var nOperands: Int
    var operands: Pointer[MlirValue]
    var nRegions: Int
    var regions: Pointer[MlirRegion]
    var nSuccessors: Int
    var successors: Pointer[MlirBlock]
    var nAttributes: Int
    var attributes: Pointer[MlirNamedAttribute]
...
fn mlirOperationStateEnableResultTypeInference(
    state: Pointer[MlirOperationState],
) -> NoneType:
    ...
    return MLIR_func[
        ...
        fn (Pointer[MlirOperationState]) -> NoneType,
    ]()(state)
...
fn mlirOperationCreate(state: Pointer[MlirOperationState]) -> MlirOperation:
    ...
    return MLIR_func[
        "mlirOperationCreate", fn (Pointer[MlirOperationState]) -> MlirOperation
    ]()(state)
...
fn mlirOperationSetOperands(
    op: MlirOperation, n_operands: Int, operands: Pointer[MlirValue]
) -> NoneType:
    """Replaces the operands of the operation."""
    return MLIR_func[
        "mlirOperationSetOperands",
        fn (MlirOperation, Int, Pointer[MlirValue]) -> NoneType,
...
fn mlirOperationWalk(
    op: MlirOperation,
    callback: fn (MlirOperation, UnsafePointer[NoneType]) -> NoneType,
    user_data: UnsafePointer[NoneType],
    ...
    return MLIR_func[
        ...
        fn (
            MlirOperation,
            fn (MlirOperation, UnsafePointer[NoneType]) -> NoneType,
            UnsafePointer[NoneType],
            MlirWalkOrder,
        ) -> NoneType,
...
fn mlirBlockCreate(
    n_args: Int, args: Pointer[MlirType], locs: Pointer[MlirLocation]
) -> MlirBlock:
    """Creates a new empty block with the given argument types and transfers
    ownership to the caller."""
    return MLIR_func[
        "mlirBlockCreate",
        fn (Int, Pointer[MlirType], Pointer[MlirLocation]) -> MlirBlock,
    ]()(n_args, args, locs)
