...
#
# Last generated by connorgray at 2024-07-04 09:06:45.699415 with command
# ```
...
fn mlirAffineExprPrint(
    ...
    return MLIR_func[
        "mlirAffineExprPrint",
        fn (
            MlirAffineExpr, MlirStringCallback, UnsafePointer[NoneType]
        ) -> None,
...
fn mlirAffineExprDump(affine_expr: MlirAffineExpr) -> None:
    ...
    return MLIR_func["mlirAffineExprDump", fn (MlirAffineExpr) -> None]()(
        affine_expr
    )
