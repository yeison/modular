...
#
# Last generated by connorgray at 2024-07-04 09:06:46.911207 with command
# ```
...
fn mlirContextDetachDiagnosticHandler(
    ...
    return MLIR_func[
        ...
        fn (MlirContext, MlirDiagnosticHandlerID) -> None,
    ]()(context, id)
...
fn mlirEmitError(location: MlirLocation, message: UnsafePointer[Int8]) -> None:
    ...
    return MLIR_func[
        "mlirEmitError", fn (MlirLocation, UnsafePointer[Int8]) -> None
    ]()(location, message)
