...
#
# Last generated by connorgray at 2024-07-03 18:53:28.610264 with command
# ```
...
fn mlirDiagnosticPrint(
    ...
    return MLIR_func[
        "mlirDiagnosticPrint",
        fn (
            MlirDiagnostic, MlirStringCallback, UnsafePointer[NoneType]
        ) -> NoneType,
...
fn mlirEmitError(
    location: MlirLocation, message: UnsafePointer[Int8]
) -> NoneType:
    """Emits an error at the given location through the diagnostics engine. Used
    for testing purposes."""
    return MLIR_func[
        "mlirEmitError", fn (MlirLocation, UnsafePointer[Int8]) -> NoneType
    ]()(location, message)
