...
#
# Last generated by stef at 2024-01-12 08:19:32.571025 with command
# ```
...
fn mlirIntegerSetGetContext(set: MlirIntegerSet) -> MlirContext:
    ...
    return MLIR_func[
        "mlirIntegerSetGetContext", fn (MlirIntegerSet) -> MlirContext
    ]()(set)
...
fn mlirIntegerSetEqual(s1: MlirIntegerSet, s2: MlirIntegerSet) -> Bool:
    ...
    return MLIR_func[
        "mlirIntegerSetEqual", fn (MlirIntegerSet, MlirIntegerSet) -> Bool
    ]()(s1, s2)
...
fn mlirIntegerSetDump(set: MlirIntegerSet) -> NoneType:
    """Prints an integer set to the standard error stream."""
    return MLIR_func["mlirIntegerSetDump", fn (MlirIntegerSet) -> NoneType]()(
        set
    )
...
fn mlirIntegerSetEmptyGet(
    ...
    return MLIR_func[
        "mlirIntegerSetEmptyGet", fn (MlirContext, Int, Int) -> MlirIntegerSet
...
fn mlirIntegerSetGet(
    ...
    num_symbols: Int,
    num_constraints: Int,
    constraints: Pointer[MlirAffineExpr],
    eq_flags: Pointer[Bool],
) -> MlirIntegerSet:
    ...
    return MLIR_func[
        "mlirIntegerSetGet",
        fn (
            MlirContext, Int, Int, Int, Pointer[MlirAffineExpr], Pointer[Bool]
        ) -> MlirIntegerSet,
...
fn mlirIntegerSetReplaceGet(
    set: MlirIntegerSet,
    dim_replacements: Pointer[MlirAffineExpr],
    symbol_replacements: Pointer[MlirAffineExpr],
    num_result_dims: Int,
...
fn mlirIntegerSetIsCanonicalEmpty(set: MlirIntegerSet) -> Bool:
    ...
    return MLIR_func[
        "mlirIntegerSetIsCanonicalEmpty", fn (MlirIntegerSet) -> Bool
    ]()(set)


fn mlirIntegerSetGetNumDims(set: MlirIntegerSet) -> Int:
    """Returns the number of dimensions in the given set."""
    return MLIR_func["mlirIntegerSetGetNumDims", fn (MlirIntegerSet) -> Int]()(
        set
    )
...
fn mlirIntegerSetGetNumSymbols(set: MlirIntegerSet) -> Int:
    ...
    return MLIR_func[
        "mlirIntegerSetGetNumSymbols", fn (MlirIntegerSet) -> Int
    ]()(set)
...
fn mlirIntegerSetGetNumInputs(set: MlirIntegerSet) -> Int:
    ...
    return MLIR_func[
        "mlirIntegerSetGetNumInputs", fn (MlirIntegerSet) -> Int
    ]()(set)
...
fn mlirIntegerSetGetNumConstraints(set: MlirIntegerSet) -> Int:
    ...
    set."""
    return MLIR_func[
        "mlirIntegerSetGetNumConstraints", fn (MlirIntegerSet) -> Int
    ]()(set)
...
fn mlirIntegerSetGetNumEqualities(set: MlirIntegerSet) -> Int:
    ...
    return MLIR_func[
        "mlirIntegerSetGetNumEqualities", fn (MlirIntegerSet) -> Int
    ]()(set)
...
fn mlirIntegerSetGetNumInequalities(set: MlirIntegerSet) -> Int:
    ...
    return MLIR_func[
        "mlirIntegerSetGetNumInequalities", fn (MlirIntegerSet) -> Int
    ]()(set)
...
fn mlirIntegerSetGetConstraint(set: MlirIntegerSet, pos: Int) -> MlirAffineExpr:
    ...
    return MLIR_func[
        ...
        fn (MlirIntegerSet, Int) -> MlirAffineExpr,
    ]()(set, pos)
...
fn mlirIntegerSetIsConstraintEq(set: MlirIntegerSet, pos: Int) -> Bool:
    ...
    return MLIR_func[
        "mlirIntegerSetIsConstraintEq", fn (MlirIntegerSet, Int) -> Bool
    ]()(set, pos)
