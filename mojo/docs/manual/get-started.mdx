...
github_url: https://github.com/modular/max/tree/main/examples/mojo/life
...
Want to write a GPU function with Mojo? See how to [build a custom op
with MAX](/max/tutorials/build-custom-ops).
...
GitHub](https://github.com/modular/max/tree/main/examples/mojo/life).
...
For more detail about all of Mojo's features, explore the other sections of the
[Mojo manual](/mojo/manual/).

If you want to write a GPU function with Mojo, see how to [build a custom op
with MAX](/max/tutorials/build-custom-ops).
