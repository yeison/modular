...
Mojo will notice that you don't have a member-wise constructor (`__init__()`),
a copy constructor (`__copyinit__()`), or a move constructor
(`__moveinit__()`), and it will synthesize these for you as if you had written:
