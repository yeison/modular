...
class TestPythonModuleBuilderDefFunction(unittest.TestCase):
    ...
    def test_takes_zero_returns(self):
        ...
        self._test_takes_zero_returns(dummy.takes_zero_returns)

    def test_takes_one_returns(self):
        dummy = def_staticmethod.Dummy
        self._test_takes_one_returns(dummy.takes_one_returns)

    def test_takes_two_returns(self):
        dummy = def_staticmethod.Dummy
        self._test_takes_two_returns(dummy.takes_two_returns)

    def test_takes_three_returns(self):
        dummy = def_staticmethod.Dummy
        self._test_takes_three_returns(dummy.takes_three_returns)
    ...
    def test_takes_zero_raises_returns(self):
        ...
        self._test_takes_zero_returns(dummy.takes_zero_raises_returns)
    ...
    def test_takes_one_raises_returns(self):
        ...
        self._test_takes_one_returns(dummy.takes_one_raises_returns)
    ...
    def test_takes_two_raises_returns(self):
        ...
        self._test_takes_two_returns(dummy.takes_two_raises_returns)
    ...
    def test_takes_three_raises_returns(self):
        ...
        self._test_takes_three_returns(dummy.takes_three_raises_returns)
    ...
    def test_takes_zero(self):
        dummy = def_staticmethod.Dummy
        self._test_takes_zero(dummy.takes_zero)

    def test_takes_one(self):
        dummy = def_staticmethod.Dummy
        self._test_takes_one(dummy.takes_one)

    def test_takes_two(self):
        dummy = def_staticmethod.Dummy
        self._test_takes_two(dummy.takes_two)

    def test_takes_three(self):
        dummy = def_staticmethod.Dummy
        self._test_takes_three(dummy.takes_three)
    ...
    def test_takes_zero_raises(self):
        ...
        self._test_takes_zero(dummy.takes_zero_raises)
    ...
    def test_takes_one_raises(self):
        ...
        self._test_takes_one(dummy.takes_one_raises)
    ...
    def test_takes_two_raises(self):
        ...
        self._test_takes_two(dummy.takes_two_raises)
    ...
    def test_takes_three_raises(self):
        ...
        self._test_takes_three(dummy.takes_three_raises)
