...
def wgmma_e4m3_e4m3_f32_64x8x32(ctx: DeviceContext):
    ...
    var lhs = ManagedLayoutTensor[
        DType.float8e4m3, Layout.row_major(M, K), gpu_managed_alloc, gpu_free
    ]()
    ...
    var rhs = ManagedLayoutTensor[
        DType.float8e4m3, Layout.row_major(K, N), gpu_managed_alloc, gpu_free
    ]()
    ...
    var func = ctx.compile_function[
        wgmma_e4m3_e4m3_f32_kernel_fn, target = _get_nvptx_target["sm_90"]()
    ]()
...
def wgmma_e5m2_e5m2_f32_64x8x32(ctx: DeviceContext):
    ...
    var lhs = ManagedLayoutTensor[
        DType.float8e5m2, Layout.row_major(M, K), gpu_managed_alloc, gpu_free
    ]()
    ...
    var rhs = ManagedLayoutTensor[
        DType.float8e5m2, Layout.row_major(K, N), gpu_managed_alloc, gpu_free
    ]()
    ...
    var func = ctx.compile_function[
        wgmma_e5m2_e5m2_f32_kernel_fn, target = _get_nvptx_target["sm_90"]()
    ]()
...
def wgmma_e4m3_e5m2_f32_64x8x32(ctx: DeviceContext):
    ...
    var func = ctx.compile_function[
        wgmma_e4m3_e5m2_f32_kernel_fn, target = _get_nvptx_target["sm_90"]()
    ]()
...
def wgmma_e5m2_e4m3_f32_64x8x32(ctx: DeviceContext):
    ...
    var func = ctx.compile_function[
        wgmma_e5m2_e4m3_f32_kernel_fn, target = _get_nvptx_target["sm_90"]()
    ]()
...
def wgmma_e4m3_e4m3_f16_64x8x32(ctx: DeviceContext):
    ...
    var func = ctx.compile_function[
        wgmma_e4m3_e4m3_f16_kernel_fn, target = _get_nvptx_target["sm_90"]()
    ]()
...
def wgmma_e5m2_e5m2_f16_64x8x32(ctx: DeviceContext):
    ...
    var func = ctx.compile_function[
        wgmma_e5m2_e5m2_f16_kernel_fn, target = _get_nvptx_target["sm_90"]()
    ]()
...
def wgmma_e4m3_e5m2_f16_64x8x32(ctx: DeviceContext):
    ...
    var func = ctx.compile_function[
        wgmma_e4m3_e5m2_f16_kernel_fn, target = _get_nvptx_target["sm_90"]()
    ]()
...
def wgmma_e5m2_e4m3_f16_64x8x32(ctx: DeviceContext):
    ...
    var func = ctx.compile_function[
        wgmma_e5m2_e4m3_f16_kernel_fn, target = _get_nvptx_target["sm_90"]()
    ]()
