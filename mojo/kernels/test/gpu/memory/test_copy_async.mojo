...
from gpu.memory import DevicePointer, DTypeDevicePointer, AddressSpace
...
fn test_mbarrier(
    ...
    addr2: DevicePointer[Float32, AddressSpace.GLOBAL],
    addr3: DevicePointer[Float32, AddressSpace.SHARED],
    addr4: DTypeDevicePointer[DType.float64, AddressSpace.GLOBAL],
    addr5: DTypeDevicePointer[DType.float64, AddressSpace.SHARED],
):
