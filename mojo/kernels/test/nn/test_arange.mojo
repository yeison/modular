...
fn test_arange[
    ...
    let memory1 = _raw_stack_allocation[1, dtype, 1]()
    ...
    let memory2 = _raw_stack_allocation[1, dtype, 1]()
    ...
    let memory3 = _raw_stack_allocation[1, dtype, 1]()
    ...
    let memory4 = _raw_stack_allocation[max_output_size, dtype, 1]()
