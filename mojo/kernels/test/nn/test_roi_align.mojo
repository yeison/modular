...
fn test_roi_align_avg():
    ...
    # CHECK: 4.3999996185302734, 5.2000002861022949, 6.0, 6.8000001907348633, 7.600001335144043,
    # CHECK: 12.40000057220459, 13.200000762939453, 14.0, 14.80000114440918, 15.600000381469727,
    # CHECK: 20.400001525878906, 21.19999885559082, 22.000001907348633, 22.80000114440918, 23.599998474121094,
    # CHECK: 28.399999618530273, 29.200000762939453, 30.0, 30.80000114440918, 31.600000381469727,
    # CHECK: 36.400001525878906, 37.200000762939453, 38.0, 38.800003051757812, 39.600006103515625,
    for i in range(5):
        for j in range(5):
...
fn test_roi_align_max():
    ...
    roi_align_nhwc[
        DType.float32, out_shape, in_shape, roi_shape, 1.0, 2.0, False, "MAX"
    ](output, input, rois)
