...
fn cublas_matmul(
    ...
    if c_row_major:
        result = cublasGemmEx(
            ...
            UnsafePointer(b.data.address.bitcast[NoneType]().address),
            _convert_to_cublas_datatype[b.type](),
            K if transpose_b else N,
            UnsafePointer(a.data.address.bitcast[NoneType]().address),
            _convert_to_cublas_datatype[a.type](),
            K,
            UnsafePointer.address_of(beta).bitcast[NoneType](),
            UnsafePointer(c.data.address.bitcast[NoneType]().address),
