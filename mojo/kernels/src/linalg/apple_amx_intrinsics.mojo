...
fn dot_at_b_impl(
    ...
    memcpy[num_elements](a_buffer, a_pointer)
    memcpy[num_elements](b_buffer, b_pointer)
    ...
    if c.type == DType.float32:
        ...
        dot_at_b_impl(
            ...
            NDBuffer[
                ...
                a.data.bitcast[DType.float16]().address_space_bitcast[
            ...
            NDBuffer[
                ...
                b.data.bitcast[DType.float16]().address_space_bitcast[
                    AddressSpace.GENERIC
                ](),
            ),
        )
