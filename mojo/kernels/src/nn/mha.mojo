...
alias _NAIVE_BMM_BLOCK_TUPLE = StaticTuple[Int32, 3](32, 16, 1)
alias _NAIVE_BMM_BLOCK_DIM = LaunchDim(
    _NAIVE_BMM_BLOCK_TUPLE[0],
    _NAIVE_BMM_BLOCK_TUPLE[1],
    _NAIVE_BMM_BLOCK_TUPLE[2],
)
