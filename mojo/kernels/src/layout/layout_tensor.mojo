...
struct LayoutTensor[dtype: DType]:
    ...
    @always_inline
    fn __getitem__(self, idx: IntTuple) raises -> SIMD[dtype, 1]:
        return self.ptr.simd_load[1](self.layout(idx))

    @always_inline
    fn __setitem__(self, idx: IntTuple, val: SIMD[dtype, 1]) raises:
...
fn tile[
    ...
    src: LayoutTensor[dtype], tiler: DynamicVector[Layout], coords: IntTuple
