...
struct DataType:
    var _value: Int8
    alias R_16F = DataType(0)
    alias C_16F = DataType(1)
    alias R_16BF = DataType(2)
    alias C_16BF = DataType(3)
    alias R_32F = DataType(4)
    alias C_32F = DataType(5)
    alias R_64F = DataType(6)
    alias C_64F = DataType(7)
    alias R_4I = DataType(8)
    alias C_4I = DataType(9)
    alias R_4U = DataType(10)
    alias C_4U = DataType(11)
    alias R_8I = DataType(12)
    alias C_8I = DataType(13)
    alias R_8U = DataType(14)
    alias C_8U = DataType(15)
    alias R_16I = DataType(16)
    alias C_16I = DataType(17)
    alias R_16U = DataType(18)
    alias C_16U = DataType(19)
    alias R_32I = DataType(20)
    alias C_32I = DataType(21)
