...
fn bench_add[
    ...
    var input0 = NDBuffer[type, rank](input0_ptr.unsafe_pointer(), shape)
    var input1 = NDBuffer[type, rank](input1_ptr.unsafe_pointer(), shape)
    var output = NDBuffer[type, rank](output_ptr.unsafe_pointer(), shape)
