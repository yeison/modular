...
fn bench_stencil_avg_pool[
    ...
    # Copy to device
    ctx.enqueue_copy_to_device(d_input_buf, h_input.data)
    ctx.enqueue_copy_to_device(d_output_buf, h_output.data)
    ...
    # Run benchmarks
    var bench_name = "stencil_avg_pool_" + str(batch_size) + "x" + str(
        input_height
    ) + "x" + str(input_width) + "x" + str(num_channels)
...
fn bench_stencil_avg_pool_padded[
    ...
    # Run benchmarks
    var bench_name = "stencil_avg_pool_padded_" + str(batch_size) + "x" + str(
        input_height
    ) + "x" + str(input_width) + "_pad" + str(pad_h) + "x" + str(pad_w)
