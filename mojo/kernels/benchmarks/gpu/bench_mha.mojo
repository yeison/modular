...
fn main() raises:
    ...
    alias cfg_list = List[MHA_cfg](
        ...
        # fmask_type2 depth = 128, seqlen % 128 != 0, legacy impl
        MHA_cfg(
            mask_rank=3,
            qkv_type=DType.bfloat16,
            mask_type=DType.float32,
        ...
        # fmask_type2 arbitrary depth and num_heads, baseline impl.
        MHA_cfg(
            mask_rank=3,
            qkv_type=DType.bfloat16,
            mask_type=DType.float32,
        ...
        # fmask_type2 depth == 128, tf32-fmask_type2 mma, llama2 shape.
        MHA_cfg(
            mask_rank=4,
            qkv_type=DType.bfloat16,
            mask_type=DType.float32,
        ...
        # bf16 depth == 128, bf16-fmask_type2 mma
        MHA_cfg(
            mask_rank=4,
            qkv_type=DType.bfloat16,
