...
fn main() raises:
    ...
    var a_ptr = UnsafePointer[Scalar[dtype]].alloc[alignment=alignment](m * k)
    var b_ptr = UnsafePointer[Scalar[dtype]].alloc[alignment=alignment](k * n)
    var b2_ptr = UnsafePointer[Scalar[dtype]].alloc[alignment=alignment](k * n)
    var c_ptr = UnsafePointer[Scalar[dtype]].alloc[alignment=alignment](m * n)
    var c2_ptr = UnsafePointer[Scalar[dtype]].alloc[alignment=alignment](m * n)
