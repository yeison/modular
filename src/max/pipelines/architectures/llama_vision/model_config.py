...
# MAXModelConfig has optional fields, and LlamaVisionConfig has required fields.
# We can work around this by having a superclass of MAXModelConfig that has
# the abstract methods, and then having LlamaVisionConfig extend that.
@dataclass
class LlamaVisionConfig(MAXConfig):
    @staticmethod
