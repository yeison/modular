...
# MAXModelConfig has optional fields, and MistralConfig has required fields.
# We can work around this by having a superclass of MAXModelConfig that has
# the abstract methods, and then having MistralConfig extend that.
@dataclass
class MistralConfig(MAXConfig):
    @staticmethod
